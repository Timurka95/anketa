...
<ul>
	...
	<li>
		<?php echo $this->Form->input('age', array('label' => 'Возраст', 'min' => 3, 'max' => 100, 'value' => $profile['Profile']['age']));?>
	</li>
	<li>
		<?php echo $this->Form->input('email', array('label' => 'Email (если указан, на него будет выслан результат)', 'placeholder' => 'ivanov@mail.ru', 'value' => $profile['Profile']['email']));?>
	</li>
	<li>
		<?php echo $this->Form->input('sex', array('label' => 'Пол: ', 'options' => array('m' => 'М', 'w' => 'Ж'), 
										'default' => $profile['Profile']['sex']));?>
	</li>
	<li>
	...
	<li>
		<?php echo $this->Form->input('loc', array('label' => 'Проживание: ', 'options' => array(
																	...
																	'3' => 'Съёмная квартира',
																	'4' => 'Другое'),
													'default' => $profile['Profile']['loc'])); ?>
	</li>
	<li>
		<?php echo $this->Form->input('region', array('label' => 'Регион основного места жительства', 'placeholder' => 'Омская область', 'value' => $profile['Profile']['region']));?>
	</li>
	<li>
		<?php echo $this->Form->input('ration', array('label' => 'Оценка собственного питания (по 5-бальной шкале, где 5 - отлично, 1 - очень плохо)', 'options' => array(1,2,3,4,5), 'default' => $profile['Profile']['ration']));?>
	</li>
	<li>
		<?php echo $this->Form->input('growth', array('label' => 'Рост (м)', 'step' => '0.01',  'min' => '0.9', 'max' => '2.3', 'value' => $profile['Profile']['growth']));?>
	</li>
	<li>
		<?php echo $this->Form->input('weight', array('label' => 'Вес (кг)', 'min' => 20, 'max' => 200, 'value' => $profile['Profile']['weight']));?>
	</li>
	<li>
		<?php echo $this->Form->input('complaints', array('label' => 'Жалобы (здоровье)', 'value' => $profile['Profile']['complaints']));?>
	</li>
	<li>
		<?php 
			$val = ($profile['Profile']['waist'] > 0) ? $profile['Profile']['waist'] : '';
			echo $this->Form->input('waist', array('label' => 'Объём талии (см)', 'min' => 20, 'max' => 200, 'value' => $val));
		?>
		<span class="form_hint_label">?</span>
	...
	<li>
		<?php 
			$val = ($profile['Profile']['hips'] > 0) ? $profile['Profile']['hips'] : '';
			echo $this->Form->input('hips', array('label' => 'Объём бедёр (см)', 'min' => 40, 'max' => 200, 'value' => $val));
		?>
		<span class="form_hint_label">?</span>
	...
	<li>
		<?php
			$val = ($profile['Profile']['shoulder'] > 0) ? $profile['Profile']['shoulder'] : '';
			echo $this->Form->input('shoulder', array('label' => 'Окружность плеча (см)', 'min' => 10, 'max' => 60, 'value' => $val));
			?>
		<span class="form_hint_label">?</span>
