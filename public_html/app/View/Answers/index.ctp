<div class="answers index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('portnumb_value'); ?></th>
			<th><?php echo $this->Paginator->sort('frequency_value'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($answer['Answer']['point_id']); ?>&nbsp;</td>
		<td><?php echo h($answer['Answer']['portnumb_value']); ?>&nbsp;</td>
		<td><?php echo h($answer['Answer']['frequency_value']); ?>&nbsp;</td>
		<td class="actions">
